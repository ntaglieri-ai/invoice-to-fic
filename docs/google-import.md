...
- Pagine da 10 mail con pulsante Altre mail; Importa non archiviate elabora solo le righe caricate senza un PDF gia trovato su Drive, una alla volta. Gli errori del singolo documento lasciano proseguire; problemi di permessi, quota o servizio interrompono il lotto.
- Ogni ricerca controlla su Drive l'origine messaggio/parte dei PDF archiviati dall'app, anche dopo un refresh. Mostra il check Archiviata su Drive e permette Carica in revisione senza un nuovo download dal fornitore. File nel cestino esclusi; file aggiunti manualmente senza metadati dell'app non sono riconoscibili da questo check. Un errore della ricerca Drive mostra Stato Drive non verificato, non un falso archivio vuoto.
- Data mail visualizzata nel fuso Europe/Rome. La data fattura compare dopo l'importazione e nelle nuove archiviazioni con metadato ficDate; le vecchie archiviazioni continuano a essere riconosciute senza dover scaricare tutti i PDF durante la ricerca.
- Il menu Fornitore filtra la ricerca Gmail prima della paginazione, mantenendo mese ed etichetta. Tutti include anche i mittenti non riconosciuti. Cambiando filtro si azzerano lista e cursore; la revisione delle fatture gia importate resta invariata.
...
- Le letture Google con limiti temporanei o errori 5xx sono ritentate al massimo due volte con attesa crescente. Errori Google e download OpenAI registrano solo servizio/fase/codice, mai link privati, contenuti delle mail o credenziali. Un 403 non viene automaticamente interpretato come token scaduto.
